...
export const jmapPlugin = {
    ...
    status: {
        ...
        buildAccountSnapshot: ({ account, runtime }) => {
            ...
            const latest = (left, right) => Math.max(left ?? 0, right ?? 0) || null;
            const runtimeToolAt = activity?.lastToolCallAt ?? null;
            const useRuntimeTool = runtimeToolAt !== null &&
            ...
            return {
                ...
                lastSuccessfulPollAt: latest(observed.lastSuccessfulPollAt, activity?.lastSuccessfulPollAt),
                ...
                lastInboundMessageAt: latest(observed.lastInboundMessageAt, activity?.lastInboundMessageAt),
                lastInboundLatencyMs: latest(observed.lastInboundAt, activity?.lastInboundAt) === activity?.lastInboundAt
                ...
                lastToolSucceededAt: latest(observed.lastToolSucceededAt, activity?.lastToolSucceededAt),
