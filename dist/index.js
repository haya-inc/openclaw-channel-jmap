...
import { createJmapOutboundSafetyPolicy, hasAutonomousJmapOutboundConfig, } from "./src/outbound-policy.js";
...
const plugin = defineChannelPluginEntry({
    ...
    registerFull(api) {
        ...
        api.registerToolMetadata({
            ...
            description: "External email delivery. Reviewed mode requires one-time operator approval.",
            risk: "high",
        ...
        api.registerToolMetadata({
            ...
            description: "Autonomous-only compatibility path that sends without the draft review flow.",
            risk: "high",
